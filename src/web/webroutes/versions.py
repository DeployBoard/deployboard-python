...
versions_page = Blueprint("versions_page", __name__)
...
def versions():
    """
    Queries our services api endpoint then passes that data into the versions template
    """
    try:
    ...
    return render_template(
        "versions.html", services=services, environment_list=environments
    )
