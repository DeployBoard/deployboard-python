...
def test_check_response_contains_hashed_password_as_value():
    # If a protected keyword is a value, that's fine.
    # For example if someone named an application 'hashed_password'.
...
def test_check_response_contains_salt_as_value():
    # If a protected keyword is a value, that's fine.
    # For example if someone named an application 'salt'.
